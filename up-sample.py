...
def up_sample(img_path:str):
    ...
    try:
        ...
        print(e)
    image = cv.resize(image, dsize=(1024, 1024), interpolation=interpolation_method())
    return image


if __name__ == '__main__':
    import os
    data_dir = os.path.join(os.path.dirname(__file__), 'HR')
    LR_dir = os.path.join(os.path.dirname(__file__), 'HR1')
    
    for i in range(1, 3551):
